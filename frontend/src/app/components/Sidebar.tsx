            ...
            <div className="h-full flex flex-col p-4">
                ...
                <div className="space-y-4 flex-shrink-0">
                    <button 
                        ...
                        className="flex flex-row justify-center bg-sidebarButtonYellow space-x-2 w-full p-4 border border-customGray text-customGray rounded-lg hover:bg-sidebarButtonHover group"
                    >
                        <UsersRound size={24} className="transform transition-transform group-hover:-translate-x-2" />
                        <span className="flex-1 text-sm font-semibold">Create new group</span>
                    </button>
                    <button
                        onClick={() => setShowJoinModal(true)}
                        className="flex flex-row justify-center bg-sidebarButtonYellow space-x-2 w-full p-4 border border-customGray text-customGray rounded-lg hover:bg-sidebarButtonHover group"
                    >
                        <UserRoundPlus size={24} className="transform transition-transform group-hover:-translate-x-2" />
                        <span className="flex-1 text-sm font-semibold">Join group with code</span>
                    </button>
                </div>
            </div>
            {showCreateModal && (
